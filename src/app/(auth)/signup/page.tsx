    ...
    return(
        <main className="h-[100%] w-[100%] bg-pribg flex justify-center items-center py-[8%] px-[37%]">
          <div className="bg-secbg w-full py-[3rem]   rounded-[10px] justify-center flex-col items-center flex">
                ...
                <div>
                    <InputField type="username" id="username" /> 
                    <InputField type="email" id="email" />
                    <InputField type="password" id="password" />
                </div>
                <div className="w-[14.8rem]">
                <p className="text-[11px] my-[0.4rem] text">Already have an Account?<Link href={'/singup'} className="text-buttons underline underline-offset-1 decoration-1">Login</Link></p>
                </div>
                <SubmitButton buttonType="SignUp"/>
            </div>
        </main>
    )
}
